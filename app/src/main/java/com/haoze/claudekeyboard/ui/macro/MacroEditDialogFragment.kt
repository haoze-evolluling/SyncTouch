...
class MacroEditDialogFragment : DialogFragment() {
    ...
    companion object {
        ...
        private const val ARG_MACRO_DESCRIPTION = "macro_description"
        ...
        fun newInstance(macro: Macro): MacroEditDialogFragment {
            return MacroEditDialogFragment().apply {
                arguments = Bundle().apply {
                    ...
                    putString(ARG_MACRO_DESCRIPTION, macro.description)
    ...
    private var onSaveListener: ((String?, String, String, String, Boolean) -> Unit)? = null
     ...
     */
    fun setOnSaveListener(listener: (String?, String, String, String, Boolean) -> Unit) {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val macroDescription = arguments?.getString(ARG_MACRO_DESCRIPTION) ?: ""
        ...
        val etDescription = view.findViewById<EditText>(R.id.et_macro_description)
        ...
        if (isEdit) {
            ...
            etDescription.setText(macroDescription)
        ...
        val dialogBuilder = MaterialAlertDialogBuilder(requireContext())
            ...
            .setPositiveButton(R.string.dialog_save) { _, _ ->
                ...
                if (label.isNotEmpty() && command.isNotEmpty()) {
                    onSaveListener?.invoke(macroId, label, description, command, sendEnter)
                }
            }
