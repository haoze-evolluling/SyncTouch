...
class CircularDpadView @JvmOverloads constructor(
    ...
    init {
        attrs?.let {
            ...
            ringColor = a.getColor(R.styleable.CircularDpadView_ringColor, ContextCompat.getColor(context, R.color.surface_container))
            ringBorderColor = a.getColor(R.styleable.CircularDpadView_ringBorderColor, ContextCompat.getColor(context, R.color.outline_variant))
            centerColor = a.getColor(R.styleable.CircularDpadView_centerColor, ContextCompat.getColor(context, R.color.surface_container))
            centerBorderColor = a.getColor(R.styleable.CircularDpadView_centerBorderColor, ContextCompat.getColor(context, R.color.outline_variant))
            dividerColor = a.getColor(R.styleable.CircularDpadView_dividerColor, ContextCompat.getColor(context, R.color.outline_variant))
            ...
            ringColor = ContextCompat.getColor(context, R.color.surface_container)
            ringBorderColor = ContextCompat.getColor(context, R.color.outline_variant)
            centerColor = ContextCompat.getColor(context, R.color.surface_container)
            centerBorderColor = ContextCompat.getColor(context, R.color.outline_variant)
    ...
    private fun setupPaints() {
        ...
        highlightPaint.apply {
            color = if (highlightColor != 0) {
                highlightColor
            } else {
                (ringBorderColor and 0x00FFFFFF) or 0x33000000
            }
            style = Paint.Style.FILL
        }
        textPaint.apply {
